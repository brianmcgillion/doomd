...
;; Make treesit more colorful and highlight more cases
...
(use-package! org-super-agenda
  ...
  (setq
   ...
   '((agenda . " %(vulpea-agenda-category 30) %?-12t %12s")
     (todo . " %(vulpea-agenda-category 20) ")
     (tags . " %(vulpea-agenda-category 25) ")
     (search . " %(vulpea-agenda-category 20) "))

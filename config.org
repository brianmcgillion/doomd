...
;; TODO Revisit this when https://github.com/doomemacs/doomemacs/issues/6936 is fixed
;;(set-formatter! 'alejandra "alejandra --quiet" :modes '(nix-mode))
;; format-all--executable-table started to fail now
(after! nix-mode
  (set-formatter! 'alejandra '("alejandra" "--quiet") :modes '(nix-mode)))
;;  (puthash 'alejandra "alejandra" format-all--executable-table))

;; Allow alejandra to format the code
